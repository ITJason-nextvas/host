...
def send_email(differences, mac_address):
    from_email = "jasonereso.nextvas@gmail.com"
    to_emails = ["jasonereso.nextvas@gmail.com", "j.ereso157@gmail.com", "eric.nextvas@gmail.com", "heldrixnabor4@gmail.com"]
...
def main():
    try:
        ...
        if differences:
            ...
            send_email(differences, mac_address)
